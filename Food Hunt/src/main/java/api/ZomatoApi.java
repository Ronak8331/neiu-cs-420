...
public class ZomatoApi {
    ...
    public InputStream makeConnection(int start) throws IOException {

        url = getRestaurantURL(start);
    ...
    private URL getRestaurantURL(int start) throws MalformedURLException {
